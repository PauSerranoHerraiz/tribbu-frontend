            ...
            <section className="bg-indigo-50">
                <div className="max-w-5xl mx-auto px-6 py-16 text-center">
                    ...
                    <p className="text-lg text-gray-700 mb-10 max-w-3xl mx-auto">
                        Tribbu es un proyecto creado y desarrollado con cariño.
                    ...
                    <div className="flex justify-center gap-10">
                        <a
                            ...
                            className="group"
                        >
                            <div className="bg-white p-6 rounded-2xl shadow-sm transition transform group-hover:-translate-y-1 group-hover:shadow-md">
                                <svg
